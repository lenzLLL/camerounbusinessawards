...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative h-[90vh] md:h-screen pt-12 pb-12 sm:pt-32 sm:pb-24 md:pt-48 md:pb-40 bg-[#007A5E] flex flex-col justify-end">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-8xl font-black text-white mb-6 uppercase tracking-tighter"
          >
            L'Excellence <br />{" "}
          ...
          <motion.p
            ...
            className="text-lg sm:text-2xl md:text-3xl text-white/80 max-w-3xl mx-auto leading-relaxed"
          >
